...
@Serializable
data class GstCalcRequest(
    val amount: Double,
    val gstPercent: Double,
    val mode: String   // ADD (amount is the base) or REMOVE (amount is the final, GST-inclusive price)
)

@Serializable
data class GstCalcResponse(
    val success: Boolean = true,
...
data class SettingsData(
    ...
    val useDynamicColor: Boolean = true     // Material You wallpaper-based theming (Android 12+)
)
